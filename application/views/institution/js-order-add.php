<script>
    ...
    const setInvoice = (customer, invoiceStatus, invoice, el) => {
        $.ajax({
            url: `${url}institution/setinvoice`,
            method: 'POST',
            data: {
                customer,
    ...
    $(document).ready(function() {
        ...
        $('#product-name').autocomplete({
            source: function(request, response) {
                // Fetch data
                $.ajax({
                    url: `${url}institution/getproduct`,
                    type: 'POST',
                    dataType: 'JSON',
                    data: {
    ...
    const getDetailProduct = id => {
        $.ajax({
            url: `${url}institution/getdetailproduct`,
            method: 'POST',
            data: {
                id
            },
    ...
    const deleteDetail = id => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: `${url}institution/deletedetail`,
                    method: 'POST',
                    data: {
                        id
                    },
    ...
    const cancelOrder = () => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: `${url}institution/deleteorder`,
                    method: 'POST',
                    data: {
                        id: $('#invoice').val()
                    },
